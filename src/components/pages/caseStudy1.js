        ...
        <div className="container content">
          ...
          <div className="container-fluid highlight">
            <div className="container highlightContent">
              ...
              <div id="text">The idea for this app came about when my friends and I faced the challenge of finding the perfect place to spend a Saturday night out downtown Toronto, during our last co-op term. A Google search or blogTO article was just not cutting it, since we could never decide on a venue that matched all of our needs. This is when my classmate and I came to the realization that we could develop an app that would aim to solve this exact problem. However, we needed to break this problem down further to understand the reasons why we were encountering this problem.
          ...
          <div className="container-fluid" id="underHighlight">
            ...
            <div className="container-fluid" id="underHighlight">
              <div className="container highlightContent">
                ...
                <div id="text">
                  ...
                  Moreover, there were certain features, transitions and designs that I wanted impleted, but they were too diffult to implement as my classmate was solo-developing the app. I quickly learned that I had to have more realistic design features
            ...
            <div className="container-fluid" id="underHighlight">
              <div className="container highlightContent">
                ...
                <ul>
                <br/><li>Combine all of the filters into one page, this would reduce the amount of work required to create seperate filter pages</li>
                ...
                <li>The 'Randomize location' button on the results page would take too long to implement - so I removed it</li>
                <li>In the first wireframes I had forgotten the result details page, so I wireframed how that page could be potentially laid out</li>
                </ul>
                </div>
                <div className="row">
                    <div class="col-lg-12">
                ...
                <div id="step-description">The final mockups, as well as the differnt fidelity of wireframes, were all created using Sketch. Since the design followed Google Material Design, I was able to leverage the material design components file in order to
